...
namespace GitCredentialManager.Tests
{
    public class GitConfigurationTests
    {
        ...
        public void GitConfiguration_ScopedConfig_ProcessesIncludes()
        {
            ...
            string gitGlobal = System.Environment.GetEnvironmentVariable("GIT_CONFIG_GLOBAL");

            try {
                System.Environment.SetEnvironmentVariable("GIT_CONFIG_GLOBAL", repoPath + "/global.config");
            ...
            {
                System.Environment.SetEnvironmentVariable("GIT_CONFIG_GLOBAL", gitGlobal);
            }
        }
    }
}
