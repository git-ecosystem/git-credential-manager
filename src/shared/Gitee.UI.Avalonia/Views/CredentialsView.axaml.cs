...
namespace Gitee.UI.Views
{
    public class CredentialsView : UserControl, IFocusable
    {
        ...
        private DrawingImage _GiteeLogoTypeImage;
        ...
        public IImage GiteeLogoTypeImage
        {
            get
            {
                if (_GiteeLogoTypeImage is null)
                {
                    ...
                    _GiteeLogoTypeImage = new DrawingImage
                    {
                        Drawing = new DrawingGroup
                        {
                            Children =
