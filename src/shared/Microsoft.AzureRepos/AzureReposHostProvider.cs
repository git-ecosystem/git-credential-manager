...
namespace Microsoft.AzureRepos
{
    public class AzureReposHostProvider : DisposableObject, IHostProvider, IConfigurableComponent, ICommandProvider
    {
        ...
        public Task UnconfigureAsync(ConfigurationTarget target)
        {
            ...
            // On Windows, if there is a "manager" (or "manager-core") entry remaining in the system config then
            // we must not clear the useHttpPath option otherwise this would break the bundled version of GCM
            // in Git for Windows.
