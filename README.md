...
[Git Credential Manager][gcm] (GCM) is a secure [Git credential helper][gch] built
on [.NET][dotnet] that runs on Windows, macOS, and Linux. It aims to provides a
consistent and secure authentication experience, including multi-factor auth, to
every major source control hosting service and platform.
...
[gch]: https://git-scm.com/docs/gitcredentials
